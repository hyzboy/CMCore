...
void TestSetOperations()
{
    ...
    // 并集
    FlatUnorderedSet<int> union_set;
    ...
    // 交集
    FlatUnorderedSet<int> intersect_set;
...
void TestManagedSet()
{
    ...
    // 对于平凡类型，使用 FlatUnorderedSet
    {
        FlatUnorderedSet<TestObject> value_set;

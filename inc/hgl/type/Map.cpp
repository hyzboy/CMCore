...
//      LogWarning(OS_TEXT("Map::Find,no result."));
    ...
    */
     ...
     */
    template<typename K,typename V,typename KVData>
    void MapTemplate<K,V,KVData>::WithList(MapTemplate<K,V,KVData>::KVDataList &with_list,const ValueArray<K> &in_list)
    {
        with_list.Clear();
     ...
     */
    template<typename K,typename V,typename KVData>
    void MapTemplate<K,V,KVData>::WithoutList(MapTemplate<K,V,KVData>::KVDataList &without_list,const ValueArray<K> &in_list)
    {
        without_list.Clear();
        const int count=this->GetCount();

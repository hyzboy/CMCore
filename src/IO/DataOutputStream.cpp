...
namespace hgl
{
    ...
    namespace io    //write utf8 string
    {
        ...
        template<typename T> bool DataOutputStream::WriteUTF8StringWithLength(const U16String &str)
        {
            if(!out)return(false);
    ...
    namespace io
    {
        ...
        bool DataOutputStream::WriteUTF8String        (const U8String &str      ){return WriteUTF8StringWithLength<uint32>(str.c_str(), str.Length());}                         ///<按utf8格式写入字符串(前置4字节字符串长度,再写入字符阵列)
        bool DataOutputStream::WriteUTF8String        (const U16String &str     ){return WriteUTF8StringWithLength<uint32>(str);}                                               ///<按utf8格式写入字符串(前置4字节字符串长度,再写入字符阵列)
        ...
        bool DataOutputStream::WriteUTF8ShortString   (const U8String &str      ){return WriteUTF8StringWithLength<uint16>(str.c_str(), str.Length());}                         ///<按utf8格式写入字符串(前置2字节字符串长度,再写入字符阵列)
        bool DataOutputStream::WriteUTF8ShortString   (const U16String &str     ){return WriteUTF8StringWithLength<uint16>(str);}                                               ///<按utf8格式写入字符串(前置2字节字符串长度,再写入字符阵列)
        ...
        bool DataOutputStream::WriteUTF8TinyString    (const U8String &str        ){return WriteUTF8StringWithLength<uint8>(str.c_str(),  str.Length());}                       ///<按utf8格式写入字符串(前置1字节字符串长度,再写入字符阵列)
        bool DataOutputStream::WriteUTF8TinyString    (const U16String &str       ){return WriteUTF8StringWithLength<uint8>(str);}                                              ///<按utf8格式写入字符串(前置1字节字符串长度,再写入字符阵列)
